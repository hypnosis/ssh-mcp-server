 ...
 */
export function validateArrayParameter(value, parameterName = 'parameter') {
 ...
 */
function formatErrorMessage(receivedValue, parameterName) {
 ...
 */
export function createValidationErrorResponse(errorMessage) {
    return {
