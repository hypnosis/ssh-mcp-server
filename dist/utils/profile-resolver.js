...
import { loadProfilesFile } from './profiles-file.js';
/**
 ...
 */
function watchProfilesFile(filePath) {
    if (!WATCH_PROFILES) {
...
export function resolveSSHConfig(args) {
    ...
    if (args.profile) {
        ...
        if (!profileData) {
            ...
            throw new Error(`Profile "${args.profile}" not found in SSH_PROFILES_FILE. ` +
