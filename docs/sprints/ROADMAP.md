...
| [CORE_11](planned/CORE_11_ssh2_removal.md) | Один транспорт вместо двух: флип дефолта, снос `ssh2`, дубли, хвосты | 📋 запланирован |
...
**Осталось до релиза v2.0.0:** жалобы с боевого использования (этап 4), живой смоук с
парольным профилем, флип дефолта на openssh, удаление ssh2 и документация мажорного
релиза (`docs/transfer.md` описывает старую механику).
