...
**Статус:** 🔧 шаги 1 и 2 сделаны и проверены живьём 2026-08-18, остался релиз
...
Одним релизом с аннотациями, которые уже лежат под `[Unreleased]`: это одна тема —
сервер рассказывает о себе.
