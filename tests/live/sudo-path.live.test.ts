 ...
 * /tmp от имени пользователя, оттуда `sudo cp --` кладёт копию рядом с целью,
 * там она получает права и владельца, и переименование ставит её на место.
 * Проверялось это полгода лишь наполовину —
